...
public class TempReservAdapter extends BaseAdapter // 리스트 사용 위한 클래스
{
    LayoutInflater inflater = null;
    private ArrayList<TempData> m_oData = null;
    private int nListCnt = 0;

    public TempReservAdapter(ArrayList<TempData> _oData)
    {
        m_oData = _oData;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.items_temp_reservations, parent, false);
        }
